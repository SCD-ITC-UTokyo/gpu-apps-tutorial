...
void MAT_CON0()
{
  ...
  for( icel=0;icel< ICELTOT;icel++){
    in1=ICELNOD_g(icel,0);
    in2=ICELNOD_g(icel,1);
    in3=ICELNOD_g(icel,2);
    in4=ICELNOD_g(icel,3);
    in5=ICELNOD_g(icel,4);
    in6=ICELNOD_g(icel,5);
    in7=ICELNOD_g(icel,6);
    in8=ICELNOD_g(icel,7);
