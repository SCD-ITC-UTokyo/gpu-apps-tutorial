...
void MAT_CON0()
{
  ...
  for( icel=0;icel< ICELTOT;icel++){
    in1=ICELNOD_h(icel,0);
    in2=ICELNOD_h(icel,1);
    in3=ICELNOD_h(icel,2);
    in4=ICELNOD_h(icel,3);
    in5=ICELNOD_h(icel,4);
    in6=ICELNOD_h(icel,5);
    in7=ICELNOD_h(icel,6);
    in8=ICELNOD_h(icel,7);
