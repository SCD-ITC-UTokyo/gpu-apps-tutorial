...
!C*** 
!C
      pure subroutine JACOBI (DETJ, PNQ, PNE, PNT, PNX, PNY, PNZ,
...
!     C
     ...
     &           local(icel,in1,in2,in3,in4,in5,in6,in7,in8,nodLOCAL,
     &           X1,X2,X3,X4,X5,X6,X7,X8,
     &           Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8,
     &           Z1,Z2,Z3,Z4,Z5,Z6,Z7,Z8,
     &           QVC,DETJ,PNX,PNY,PNZ,
     &           ie,je,ip,jp,kk,iiS,iiE,k,
     &           QV0,COEFij,ipn,jpn,kpn,coef,
     &           PNXi,PNYi,PNZi,PNXj,PNYj,PNZj,SHi)
