...
if [ "$task" = "build" ]; then
    ...
    make -C src FP_L=32 FP_M=32 BENCH=1 clean install
    make -C src FP_L=64 FP_M=64 BENCH=1 clean install
    make -C src FP_L=32 FP_M=64 BENCH=1 clean install
    make -C src FP_L=32 FP_M=32 BENCH=0 clean install
    make -C src FP_L=64 FP_M=64 BENCH=0 clean install
    make -C src FP_L=32 FP_M=64 BENCH=0 clean install
    exit 0
fi
